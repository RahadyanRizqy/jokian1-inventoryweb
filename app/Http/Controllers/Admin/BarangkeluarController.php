...
class BarangkeluarController extends Controller
{
    public function index()
    {
        ...
        $data["teknisi"] = TeknisiModel::orderBy('teknisi_id', 'DESC')->get();
    ...
    {
        if ($request->ajax()) {
            $data = BarangkeluarModel::leftJoin('tbl_barang', 'tbl_barang.barang_kode', '=', 'tbl_barangkeluar.barang_kode')->leftJoin('tbl_teknisi', 'tbl_teknisi.teknisi_id', '=', 'tbl_barangkeluar.teknisi_id')->orderBy('bk_id', 'DESC')->get();
            return DataTables::of($data)
                ...
                ->addColumn('teknisi', function ($row) {
                    $teknisi = $row->teknisi_id == '' ? '-' : $row->teknisi_nama;
                ...
                ->rawColumns(['action', 'tgl', 'tujuan', 'teknisi','barang'])->make(true);
        }
    }
